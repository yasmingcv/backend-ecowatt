...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pontuation: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSimulationSimulation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    carbonEmitted: Schema.Attribute.String;
    company: Schema.Attribute.Relation<'oneToOne', 'api::company.company'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    peakDemandReduction: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    renewableEnergy: Schema.Attribute.String;
    renewableEnergySource: Schema.Attribute.String;
    totalUse: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::simulation.simulation': ApiSimulationSimulation;
